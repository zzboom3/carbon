...
//    }
    ...
    @GetMapping("/updateByNum")
    @ApiOperation(value = "根据文档编号和位置修改指定区域内容(GET)", notes = "根据文档编号和位置修改指定区域内容")
    public ApiResult updateFileByNumGet(String templateNum, String position, String replaceText) {
        return updateFileByNum(templateNum, position, replaceText);
    }
    ...
    @GetMapping("/update")
    @ApiOperation(value = "修改指定内容(GET)", notes = "修改指定内容")
    public ApiResult updateFileGet(String fileToken, String text, String replaceText) {
        return updateFile(fileToken, text, replaceText);
    }

    @GetMapping("/update/test")
    @ApiOperation(value = "测试更新接口", notes = "测试更新接口")
    public ApiResult updateTest() {
