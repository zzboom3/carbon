  ...
  >
    ...
    >
      ...
      <el-form-item prop="tradeQuantity">
        <label slot="label">供应数量(tCO2e)<span style="color: red">*</span></label>
...
export default {
  ...
  data() {
    return {
      ...
      formRules: {
        ...
        assetTypeName: [{ required: true, message: "请选择资产类型", trigger: "change" }],
  ...
  methods: {
    ...
    initParams() {
      ...
      this.isProjectTypeDisable = isProjectTypeDisable(this.subForm.assetType[0]);
