  ...
  >
    <el-form label-position="left" label-width="130px">
      ...
      <el-form-item label="资产类型">
        <el-input disabled v-model="subForm.assetTypeName" size="medium" class="contentItem" />
      </el-form-item>
      <el-form-item label="项目类型">
        <el-input disabled v-model="subForm.projectTypeName" size="medium" class="contentItem" />
      </el-form-item>
      <el-form-item label="供应数量(tCO2e)">
        <el-input disabled v-model="subForm.tradeQuantity" size="medium" class="contentItem" />
      </el-form-item>
      <el-form-item label="报价(¥)">
        <el-input disabled v-model="subForm.assetUnitPrice" size="medium" class="contentItem" />
      </el-form-item>
      <el-form-item label="期望交割日期">
        <el-input disabled v-model="subForm.deliveryTime" size="medium" class="contentItem" />
      </el-form-item>
