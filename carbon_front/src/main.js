...
const __defaultWarnHandler = Vue.config.warnHandler
Vue.config.warnHandler = (msg, vm, trace) => {
  if (typeof msg === 'string' && msg.indexOf('Prop being mutated: \"placement\"') !== -1) {
    return
  }
  if (__defaultWarnHandler) {
    return __defaultWarnHandler(msg, vm, trace)
  }
